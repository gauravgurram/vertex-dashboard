    ...
    <span>Log Out</span>
        ...
        <div id="main">
                    ...
                    <div class="row" id="table-hover-row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <td><?php echo $rw[3];?></td>
                                <td><a href="update-aboutus.php?id=<?php echo $rw[0];?>"><h3><i class="bi bi-pencil-square"></i></a>
                                                        &nbsp;
                                    <a href="delete-aboutus.php?id=<?php echo $rw[0];?>"><i class="bi bi-trash"></i></a>
                                </td>
                                </tr>
            <?php
            }
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql="insert into aboutus(name,image,post) values('$title','$filestore','$post')";
