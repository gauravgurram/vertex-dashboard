                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column" class="form-control"
                                                placeholder="Description" name="describe" value="<?php echo $rw[2]?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group"><br><br>
                                            <label for="city-column">Previous File : </label>&emsp;&emsp;&emsp;
                                            <input type="image" name="file" src="<?php echo $rw[3]?>" width="100">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group"><br><br><br><br><br>
                                            ...
                                            &emsp;&emsp;
                                            <input type="file" name="file" value="<?php echo $rw[3]?>" required>
                                        </div>
                                    </div>
...
if(isset($_POST['submit']))
{
    ...
    $sql="update services set title='$title',descri='$describe',images='$filestore' where id='$id'";
