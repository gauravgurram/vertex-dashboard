...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
            <a href="index.html"><img src="assets/images/logo/hel.png" alt="Logo"></a> 
            </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="last-name-column" class="form-control"
                                            placeholder="Describe" name="describe">
                                    </div>
                                </div>
                    ...
                    <div class="card-body">  
                        ...
                        <input type="file" class="multiple-files-filepond" name="file" multiple>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <input type="submit" class="btn btn-primary me-1 mb-1" name="submit" value="Submit"></button>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <tr>
                 ...
                 <td><?php echo $rw[1];?></td>
                <td><?php echo $rw[3];?></td>
                <td><a href="<?php echo $rw[2]?>"><img src="<?php echo $rw[2]?>" width="100" height="100"></a></td>
                <td><a href="update-portfolio.php?id=<?php echo $rw[0];?>"><h3><i class="bi bi-pencil-square"></i></a>
                                        &nbsp;
                    <a href="delete-portfolio.php?id=<?php echo $rw[0];?>"><i class="bi bi-trash"></i></a>
                </td>
                </tr>
<?php
}
...
$sql="insert into portfolio(title,image,description) values('$title','$filestore','$describe')";
