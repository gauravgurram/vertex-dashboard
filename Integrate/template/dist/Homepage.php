    ...
    <span>Log Out</span>
        ...
        <div id="main">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <tr>
                                 ...
                                 <td><?php echo $rw[1];?></td>
                                <td><?php echo $rw[2];?></td>
                                <td><a href="<?php echo $rw[2]?>"><img src="<?php echo $rw[3]?>" width="100" height="100"></a></td>
                                <td><a href="update-homepage.php?id=<?php echo $rw[0];?>"><h3><i class="bi bi-pencil-square"></i></a>
                                                        &nbsp;
                                    <a href="delete-testimon.php?id=<?php echo $rw[0];?>"><i class="bi bi-trash"></i></a>
                                </td>
                                </tr>
            <?php
            }
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql="insert into testimonial(name,descri,images) values('$title','$post','$filestore')";
