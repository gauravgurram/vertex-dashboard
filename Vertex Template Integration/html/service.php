      ...
      <div id="service" class="service">
         <div class="container">
            <div class="row">
               <div class="col-md-7">
                  <div class="titlepage">
                     <h2><strong class="yellow">service</strong><br>Lets Work Together</h2>
                  </div>
               </div>
            </div>
            <div class="portfolio">
                              ...
                              ?>
                                 <div class="col-md-6 col-sm-6">
                                    <div class="portfolio_img">
                                     <img src="../../Integrate/template/dist/<?php echo $rw[3];?>">
                                       <br>
                                      <font style="color:#191970; font-weight: bolder;margin-top: 90%;font-size: xx-large;"><?php echo $rw[1];?></font>
                                      <p style="color:black; font-weight: bolder;"><?php echo $rw[2];?></p>
                                       <div class="middle">                               
                                       </div>
                                    </div>
                                 </div> 
