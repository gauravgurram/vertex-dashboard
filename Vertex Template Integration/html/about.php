                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="contact.php">Consultant Services</a>
                                 </li>
                                 <li class="nav-item">
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-12 col-lg-7">
                  <div class="about_box">
                     <div class="titlepage">
                        <h2><strong class="yellow">About US</strong><br> We have created its space <br>in the market as a Software Development Company within<br> a short span of time.</h2>
                     </div>
                    
                     <span>Innovation to improve Business</span>
                        ...
                        <div class="row">
                           <div class="col-md-4 col-sm-6">
                              ...
                              <div class="portfolio_img">
                                 ...
                                 <br>
                                <font style="color:#191970; font-weight: bolder;margin-top: 90%;font-size: xx-large;">Our Vision</font>
                                <p style="color:black; font-weight: bolder;">Upgrading and Connecting to People with new Technology</p>
                                 <div class="middle">                               
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-4 col-sm-6">
                              <div class="portfolio_img">
                                 ...
                                 <br>
                                <font style="color:#191970; font-weight: bolder;margin-top: 90%;font-size: xx-large;">Our Mission</font>
                                <p style="color:black; font-weight: bolder;">Upgrading and Connecting to People with new Technology</p>
                              </div>
                           </div>
                           <div class="col-md-4 col-sm-6">
                              <div class="portfolio_img">
                                 ...
                                 <br>
                                <font style="color:#191970; font-weight: bolder;margin-top: 90%;font-size: xx-large;">Our Experience</font>
                                <p style="color:black; font-weight: bolder;">Upgrading and Connecting to People with new Technology</p>   
                              </div>                         
                           </div>
                        </div>
...
<!-- team  section -->
<div class="portfolio">
   <center><font color="#191970"size="8"><b>Our Expert Team</b></font></center>
<center><font color="#191970"size="4">Our Software company is a business of one or more experts that provides professional Work</font></center>
<br><br>
   <div id="myCarousel" class="carousel slide portfolio_Carousel " data-ride="carousel">
      <ol class="carousel-indicators">
         <li data-target="#myCarousel" data-slide-to="0" class="active"></li>
            ...
            <div class="container">
               <div class="carousel-caption ">
                  ...
                  <?php while($rw=mysqli_fetch_row($rs))
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="portfolio_img">
                        <img src="../../Integrate/template/dist/<?php echo $rw[2];?>" width="200" height="300">
                           <br>
                          <font style="color:#191970; font-weight: bolder;margin-top: 90%;font-size: xx-large;"><?php echo $rw[1];?></font>
                          <p style="color:black; font-weight: bolder;"><?php echo $rw[3];?></p>
                           <div class="middle">                               
                           </div>
                        </div>
                     </div>
