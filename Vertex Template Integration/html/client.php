         ...
         <div class="container">
            <div class="row">
               <div class="col-md-7 col-lg-7">
                  <div class="text-bg">
                     <h1>Career</h1>
                     <span style="font-size: larger;">Experience first ever walk in work space in Solapur. Get guidance from our skilled mentors, workshop and employment opportunities</span>
                     <p>Our focus is to provide comprehensive career services in order to support students at all the stages of their career development process. Each and every employee is important to us and we are always open to new ideas. We always treat our every employee equally and believe in growing together with team work. <br><br>Attend our workshop for tips on job searching,resumes, career development and more!</p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div id="contact" class="contact ">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="titlepage">
                              <h2><strong class="yellow">Please send your resume to <a href="" style="color:blue;">info@vertextechnosys.com</a></strong></h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-9 offset-md-2">
                           <form id="post_form" class="contact_form" method="post">
                              <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <input class="contact_control" placeholder="Qualification" type="text" name="Qualification">
                                 </div>
                                 <div class="col-md-12">
                                    <input class="contact_control" placeholder="Mobile Number " type="number" name="Mobile">
                                 </div>
                                 <div class="col-md-12">
                                    <input class="contact_control" placeholder=" Address" type="text" name="Address">
                                 </div>
                                 <div class="col-md-12">
                                    <input type="submit" class="send_btn" name="submit" value="SEND">
                                 </div>
                           </form>
                        </div>
                     </div>
                     <div class="col-md-12 col-lg-9">
                        <div class="ban_img">
                           <figure><img src="https://vertextechnosys.com/client/images/careers/careers.png" alt="#" style="margin-left: 170%; margin-top: -150%;"/></figure>
                        </div>
                     </div>
                  </div>
               </div>
...
if(isset($_POST['submit']))
{
   ...
   $sql="insert into career(name,emailid,qualify,mobile_no,address_p) 
   values('$name','$email','$qualify','$mobile','$address')";
